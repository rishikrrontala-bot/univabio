...
## Theme
“Artificial Intelligence for Human Health”: help people detect illness earlier, understand it better, or live with it more easily.
...
- Tin Computer growth credits: 100 winners × $299

## Submission requirements (from the event page)
- Website, app or coding prototype with user interaction
- Demo video explaining purpose, features and user interaction
- **One-page PDF** project description
...
| [`univabio`](https://github.com/rishikrrontala-bot/univabio) | UnivaBio **← this repo** | Tue Oct 6, 2026 · 11:45 PM EDT | Person-facing early detection or living-with-illness, private on-device. Must not overlap DSH Hacks V2, Baseline (concussion) or LARMOR (MRI). |
